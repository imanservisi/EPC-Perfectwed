<template>
    <jet-action-section>
        ...
        <template #description>
            Gérer et déconnecter votre session de vos autres appareils.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si nécessaire, vous pouvez vous déconnecter de vos autres sessions sur tous vos appareils. Vos sessions les plus récentes sont listées ci-dessous; toutefois, cette liste n'est pas exhaustive. Si vous craignez que votre compte soit compromis, vous pouvez aussi changer votre mot de passe.
            </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="confirmingLogout = false">
                ...
                <template #content>
                    Merci d'entrer votre mot de passe pour confirmer que vous souhaitez vous déconnecter de vos autres sessions sur vos autres appareils.
