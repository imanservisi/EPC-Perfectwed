...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>My Perfect Wedding</title>
        ...
        <div>
            ...
            <div class="backgroundperfectwedding">
                ...
                <div class= 'card-group deck mx-4 pull-center'>
                  ...
                  <div class="card transparent">
                    <img src="/images/money-bag.png" class="centerimg" alt="money-bag">
                    <br>
                  ...
                  <div class="card transparent">
                    <img src="/images/lightbulb.png" class="centerimg" alt="lightbulb">
                    <br>
                  ...
                  <div class="card transparent">
                    <img src="/images/writing.png" class="centerimg" alt="writing">
                    <br>
...
<style scoped>
    ...
    .backgroundperfectwedding {
      background-image: url("/images/weddingultimate.jpg");
